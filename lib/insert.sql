...
INSERT INTO characters (id, name, motto, species, author_id, series_id)
    VALUES  (1, "Lady", "Woof Woof", "direwolf", 1, 1),
            ...
            (5, "Frodo Baggins", "I will take the Ring, though I do not know the way...", "hobbit", 2, 2),
            (6, "Gollum", "My precious!", "hobbit", 2, 2),
            (7, "Arwen", "For I am the daughter of Elrond. I shall not go with him when he departs to the Havens: for mine is the choice of Lúthien, and as she so have I chosen, both the sweet and the bitter.", "half-elven", 2, 2),
            (8, "Sauron", "I made the Ring!", "maiar", 2, 2);
