...
INSERT INTO characters (id, name, motto, species, author_id, series_id) VALUES (5, "Harry", "I'm going to keep going until I succeed — or die.", "wizard", 2, 2), (6, "Hermione", "Just because you've got the emotional range of a teaspoon doesn't mean we all have.", "human/witch", 2, 2), (7, "Ron", "When in doubt, go to the library.", "wizard", 2, 2), (8, "Dumbledore", "We are only as strong as we are united, as weak as we are divided", "wizard", 2, 2);
