INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, "Henry Hermonculous", 1, 1), (2, "Margaret Megopoplous", 2, 2);

INSERT INTO subgenres (id, name) VALUES (1, "neu gothic"), (2, "space disco");

INSERT INTO authors (id, name) VALUES (1, "Roger Roger"), (2, "Amy ZzzZ");

INSERT INTO books (id, title, year, series_id) VALUES (1, "C, the C", 1996, 1), (2, "Wonder Baker", 1998, 1), (3, "Lumpkin Goods", 2000, 1), (4, "Crab Legs", 2002, 2), (5, "A Flight of Fancy", 2003, 2), (6, "Given to Tantrums", 2005, 2);
