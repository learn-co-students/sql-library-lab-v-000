...
INSERT INTO characters (name, motto, species, author_id, series_id)
  VALUES ("Gandalf", "You shall not pass!", "Human", 1, 1);
INSERT INTO characters (name, motto, species, author_id, series_id)
...
INSERT INTO characters (name, motto, species, author_id, series_id)
  VALUES ("Lady Jessica", "Beginnings are times of such peril.", "Human", 2, 2);
INSERT INTO characters (name, motto, species, author_id, series_id)
  VALUES ("Gurney Halleck", "The slow blade penetrates the shield.", "Human", 2, 2);
INSERT INTO characters (name, motto, species, author_id, series_id)
    VALUES ("Baron Harkonnen", "The spice must flow!", "Human", 2, 2);
