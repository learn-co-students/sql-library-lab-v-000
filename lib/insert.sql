...
2, 2), (6, "Graff", "We might both do despicable things, Ender, but if humankind survives, then we were good tools.", "human", 2, 2), (7, "Valentine", "Welcome to the human race. Nobody
controls his own life, Ender. The best you can do is choose to fill the roles given you by good people, by people who love you.", "human", 2, 2), (8, "Captain Dimak", "A broken clock is right two times a day.", "human",
2, 2);
