INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, 'Where the Red Fern Dies', 1, 1),
(2, 'Lord of the Kings', 2, 2);

INSERT INTO subgenres (id, name) VALUES (1, 'Historical Fiction'),
(2, 'Fantasy');

INSERT INTO authors (id, name) VALUES (1, 'Billy Bawls'),
(2, 'RJJ Toker');
