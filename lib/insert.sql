INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, "Narnia", 1, 1), (2, "Hobbiton", 2, 2);
...
INSERT INTO characters (name, motto, species, author_id, series_id) VALUES ('Aslan', 'Growl!', 'lion', 1, 1), ('James', 'Plum pudding', 'human', 1, 1), ('Eliza', 'Sic semper tyrannis', 'human', 1 ,1), ('Oliver', 'Pigbutt', 'human', 1, 1), ('Frodo', 'Finger time', 2, 2), ('Baggins', 'Eleventy-one', 2, 2), ('Gandalf', 'None shall pass', 2, 2), ('Sauron', 'evil my eye', 2,2);
