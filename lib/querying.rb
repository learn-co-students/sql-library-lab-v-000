# note : what field i need.. then if you need field from other tables.. then you use join.
 # always look for what tables has all the possible columes/ data you may need.
