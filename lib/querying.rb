...
"SELECT series.title FROM series JOIN characters on series.id = characters.series_id GROUP BY characters.species  ORDER BY COUNT(characters.species = 'human') ASC LIMIT 1;"
end
