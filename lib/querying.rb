...
def select_value_and_count_of_most_prolific_species
  "SELECT characters.species, COUNT(characters.species) AS prolific_species FROM characters
   GROUP BY characters.species ORDER BY prolific_species DESC  LIMIT 1"
end
