def select_books_titles_and_years_in_first_series_order_by_year
  "SELECT books.title, books.year FROM books JOIN series ON books.series_id = series.id WHERE series.title = 'A Song of Ice and Fire' ORDER BY books.year;"
end
...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(*) FROM characters
    ...
    GROUP BY character_books.character_id ORDER BY COUNT(*) DESC, characters.name ASC"
end
