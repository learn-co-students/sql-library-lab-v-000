...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(books.title) FROM characters JOIN series ON characters.series_id = series.id JOIN books ON books.series_id = series.id GROUP BY characters.name; "
end
