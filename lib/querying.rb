...
def select_series_title_with_most_human_characters
	...
	WHERE species='human'
	GROUP BY series.id ORDER BY COUNT(characters.species) DESC LIMIT 1;" 
end
...
def select_character_names_and_number_of_books_they_are_in
	...
	GROUP BY character_id ORDER BY COUNT(character_books.character_id) DESC, characters.name ASC;"
end
