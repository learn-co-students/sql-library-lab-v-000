...
"SELECT characters.species, count(characters.motto)
FROM characters
GROUP BY characters.species
ORDER BY count(characters.motto) DESC LIMIT 1"
end
...
AND series.author_id = authors.id"
end
...
AND series.id = characters.series_id
