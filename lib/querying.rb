...
def select_value_and_count_of_most_prolific_species
  ...
  # tables with data: characters (count & name of highest # of species)
end
...
def select_name_and_series_subgenres_of_authors
  ...
  # tables: subgenres, authors, series requires JOINs. Name = 1st item, authors = 1st table to join to 2nd item (series)
end
...
def select_character_names_and_number_of_books_they_are_in
  ...
  #tables: characters(name) books, link table
end
