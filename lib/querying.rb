...
def select_value_and_count_of_most_prolific_species
  "SELECT characters.species, count(characters.species) AS number_of_instances FROM characters GROUP BY characters.species ORDER BY number_of_instances DESC LIMIT 1"
end
