...
def select_name_and_series_subgenres_of_authors
    "SELECT authors.name, subgenres.name FROM authors, subgenres INNER JOIN series ON series.author_id = authors.id AND series.subgenre_id = subgenres.id GROUP BY authors.name"
end
