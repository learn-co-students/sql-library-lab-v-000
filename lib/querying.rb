...
def select_name_and_motto_of_char_with_longest_motto
  "SELECT characters.name, characters.motto FROM characters GROUP BY characters.name HAVING LENGTH(characters.motto) ORDER BY characters.motto LIMIT 1"
end
...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series JOIN characters GROUP BY series.title ORDER BY COUNT(characters.species) LIMIT 1"
end
