...
def select_name_and_series_subgenres_of_authors
  ...
  "INNER JOIN subgenres ON subgenres.id = series.subgenre_id GROUP BY authors.name;"
end
...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(books.id) AS book_occurrence FROM characters " +
  ...
  "GROUP BY characters.name ORDER BY book_occurrence DESC;"
end
